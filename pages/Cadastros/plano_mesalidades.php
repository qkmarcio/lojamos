...
<div class="row">
    <!-- titulo -->
    <h3 class="page-header">Lista de Planos</h3>
</div>
<!-- /.row -->    
...
<div class="row">
    ...
    <div class="col-sm-6" style="margin-bottom: 4px">
        <input class="form-control" id="busca_Aula" type="text" placeholder="Busca Plano">
    </div>
    <div class="col-sm-6">
        <button type="button" id="btn_Cadastro_Planos" class="btn btn-primary" 
...
<div class="row " style="margin-top: 5px" >
    <!-- .panel panel-default -->
    <div class="panel panel-primary" id="Form_Cadastro_Planos" style="display: none;" >
        <div class="panel-heading">
            <i class="fa fa-comments fa-fw"></i>Cadastrar Plano de Mensalidade
