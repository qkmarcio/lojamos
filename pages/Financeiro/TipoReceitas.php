...
<section class="page--header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-6">
                <!-- Page Title Start -->
                <h2 class="page--title h5">Cadastro de Tipos Receitas</h2>
                <!-- Page Title End -->

                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                    <li class="breadcrumb-item"><span>Cadastro</span></li>
                    <li class="breadcrumb-item active"><span>Tipos Receitas</span></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="panel-heading">
            ...
            <div class="row">
                <div class="col-lg-4" style="margin-bottom: 20px;">
                    <h3 class="panel-title">Lista de Tipos Receitas</h3>
                </div>
                ...
                <table class="col-lg-12 table-fixed table style--3 table-hover" style="min-width: 900px;">
                    <thead>
                        <tr>
                            ...
                            <th class="col-5 text-left">Tipos Receita</th>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Cadastro de Tipos Receitas</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="form-group px-2 col-lg-4" style="display: none">
                        <label>Codigo</label>
                        <input class="limpar form-control px-2" id="tipo_receita_id" disabled="">
                        <input id="insert" value="insert" style="display: none">
                    </div>
                    <div class="form-group px-2 col-lg-9">
                        <label name="tipo_receita_nome">Tipos Receita </label>
                        <input class="limpar form-control px-2" id="tipo_receita_nome" name="tipo_receita_nome">
                    </div>
                    <div class="form-group px-2 col-lg-3">
                        <label >Status</label>
                        <select class="form-control px-2" id="tipo_receita_ativado" >
                    ...
                    <div class="form-group px-2 col-lg-12">
                        <label>Obs</label>
                        <textarea class="limpar form-control px-2" id="tipo_receita_obs" rows="3"></textarea>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    loadjscssfile('../js/jTipoReceita.js?nocache=' + Math.random(), 'js');
